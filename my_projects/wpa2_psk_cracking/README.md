...
![Kali Linux Info](pictures/01-kali-info.png)
...
![Hotspot 1](pictures/hotspot-1.jpg)
...
![Hotspot 2](pictures/hotspot-2.jpg)

### 3. Second Laptop (Target)

![Second Laptop](pictures/second-laptop.jpg)
...
![Airmon-ng check kill](pictures/02-airmon-ng-check-kill.png)
...
![Airmon-ng start wlan0](pictures/03-airmong-ng-start-wlan0.png)
...
![Airodump-ng wlan0mon](pictures/04-airodump-ng-wlan0mon.png)
...
![Aireplay working](pictures/05-aireplay-working.png)
...
![Handshake captured](pictures/06-handshake-captured.png)
...
![Rockyou unzipped](pictures/07-rockyou-unziped.png)

Now, the captured files are ready for cracking!

![LS cap files](pictures/08-ls-cap-files.png)
...
![Wireshark capture 01 analyze](pictures/09-wirehark-capture01-analyze.png)
...
![Aircrack-ng part 1](pictures/10-aircrack-ng-part-1.png)
![Aircrack-ng part 2](pictures/11-aircrack-ng-part-2.png)
...
![Stopping wlan0mon restarting NetworkManager](pictures/12-stoping-wlan0mon-restarting-networkmanager.png)
...
![Connecting to hotspot](pictures/13-connecting-to-hotspot.png)

![Connected to AP](pictures/14-connected-to-ap.png)
